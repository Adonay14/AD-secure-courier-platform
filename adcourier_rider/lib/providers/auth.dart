...
class AuthService with ChangeNotifier {
  ...
  Future signIn(
      String email, String password, BuildContext context, String token) async {
    notifyListeners();
  ...
  Future updateProfile(String fullname, String phone, BuildContext context,
  ...
  Future<User> signInWithGoogle(BuildContext context, String playerId) async {
    ...
    await FirebaseFirestore.instance
      ...
      if (value.exists) {
        ...
        FirebaseFirestore.instance.collection('riders').doc(user.uid).set({
          'email': user.email,
