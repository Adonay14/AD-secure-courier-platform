...
String _$getVendorDetailsHash() => r'7c082833a7c17a9d18e8213a5a10aff662363441';

/// See also [getVendorDetails].
@ProviderFor(getVendorDetails)
const getVendorDetailsProvider = GetVendorDetailsFamily();

/// See also [getVendorDetails].
class GetVendorDetailsFamily extends Family<AsyncValue<UserModel>> {
  /// See also [getVendorDetails].
  const GetVendorDetailsFamily();

  /// See also [getVendorDetails].
  GetVendorDetailsProvider call(
    String vendorUID,
  ) {
    return GetVendorDetailsProvider(
      vendorUID,
    );
  }

  @override
  GetVendorDetailsProvider getProviderOverride(
    covariant GetVendorDetailsProvider provider,
  ) {
    return call(
      provider.vendorUID,
    );
  ...
  @override
  String? get name => r'getVendorDetailsProvider';
}

/// See also [getVendorDetails].
class GetVendorDetailsProvider extends AutoDisposeFutureProvider<UserModel> {
  /// See also [getVendorDetails].
  GetVendorDetailsProvider(
    String vendorUID,
  ) : this._internal(
          (ref) => getVendorDetails(
            ref as GetVendorDetailsRef,
            vendorUID,
          ),
          from: getVendorDetailsProvider,
          name: r'getVendorDetailsProvider',
          debugGetCreateSourceHash:
              const bool.fromEnvironment('dart.vm.product')
                  ? null
                  : _$getVendorDetailsHash,
          dependencies: GetVendorDetailsFamily._dependencies,
          allTransitiveDependencies:
              GetVendorDetailsFamily._allTransitiveDependencies,
          vendorUID: vendorUID,
        );

  GetVendorDetailsProvider._internal(
    super._createNotifier, {
    required super.name,
    required super.dependencies,
    required super.allTransitiveDependencies,
  ...
  @override
  Override overrideWith(
    FutureOr<UserModel> Function(GetVendorDetailsRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
      override: GetVendorDetailsProvider._internal(
        (ref) => create(ref as GetVendorDetailsRef),
        from: from,
        name: null,
        dependencies: null,
        allTransitiveDependencies: null,
  ...
  @override
  AutoDisposeFutureProviderElement<UserModel> createElement() {
    return _GetVendorDetailsProviderElement(this);
  }

  @override
  bool operator ==(Object other) {
    return other is GetVendorDetailsProvider && other.vendorUID == vendorUID;
  }

  @override
  int get hashCode {
    var hash = _SystemHash.combine(0, runtimeType.hashCode);
    hash = _SystemHash.combine(hash, vendorUID.hashCode);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin GetVendorDetailsRef on AutoDisposeFutureProviderRef<UserModel> {
  /// The parameter `vendorUID` of this provider.
  String get vendorUID;
}

class _GetVendorDetailsProviderElement
    extends AutoDisposeFutureProviderElement<UserModel>
    with GetVendorDetailsRef {
  _GetVendorDetailsProviderElement(super.provider);

  @override
  String get vendorUID => (origin as GetVendorDetailsProvider).vendorUID;
}
...
String _$fetchOrderDetailHash() => r'70b9cb474d36098bff2e838b14102d7faa131a32';
...
String _$getPercentageOfCouponHash() =>
    r'ef3fd5f5f78d2e26af97caccbfb8351a263bc2cf';
...
String _$updateWalletHash() => r'7ea42d497dbf5a7daf44022a6cc541fb13cb3639';
...
/// See also [updateWallet].
class UpdateWalletFamily extends Family<AsyncValue<void>> {
  /// See also [updateWallet].
...
/// See also [updateWallet].
class UpdateWalletProvider extends AutoDisposeFutureProvider<void> {
  /// See also [updateWallet].
  ...
  @override
  Override overrideWith(
    FutureOr<void> Function(UpdateWalletRef provider) create,
  ) {
    return ProviderOverride(
      origin: this,
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
mixin UpdateWalletRef on AutoDisposeFutureProviderRef<void> {
  /// The parameter `orderModel` of this provider.
  OrderModel2 get orderModel;
}

class _UpdateWalletProviderElement
    extends AutoDisposeFutureProviderElement<void> with UpdateWalletRef {
...
String _$updateStatusHash() => r'1bb8eb13a3e8f88d46ee5d7366c5ff2f8b57048b';
...
String _$getRidersForAutoHash() => r'b3ea4986ac435b71345263572227c04032e3563e';

/// See also [getRidersForAuto].
@ProviderFor(getRidersForAuto)
final getRidersForAutoProvider =
    AutoDisposeStreamProvider<List<String>>.internal(
  getRidersForAuto,
  name: r'getRidersForAutoProvider',
  debugGetCreateSourceHash: const bool.fromEnvironment('dart.vm.product')
      ? null
      : _$getRidersForAutoHash,
  dependencies: null,
  allTransitiveDependencies: null,
);
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef GetRidersForAutoRef = AutoDisposeStreamProviderRef<List<String>>;
...
String _$getRiderDetailHash() => r'27b81352ca6846cb6c4fcd0971f03a7b4b057d26';
