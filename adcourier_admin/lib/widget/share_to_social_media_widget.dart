...
class _ShareToSocialsState extends State<ShareToSocials> {
  void shareToFacebook() async {
    ...
    final facebookShareUrl =
        'https://www.facebook.com/sharer/sharer.php?u=https://olivette-stores-demo.web.app/product-detail/${widget.productID}';
  ...
  void shareToTwitter() async {
    ...
    final encodedUrl = Uri.encodeComponent(
        'https://olivette-stores-demo.web.app/product-detail/${widget.productID}');
  ...
  void shareToInstagram() async {
    ...
    if (await canLaunchUrl(Uri.parse(instagramUrl))) {
      ...
      await launchUrl(Uri.parse(
          '$instagramUrl?text=Olivette Store&url=https://olivette-stores-demo.web.app/product-detail/${widget.productID}'));
    } else {
  ...
  void launchWhatsApp() async {
    var whatsappUrl = "https://api.whatsapp.com/send?text=https://olivette-stores-demo.web.app/product-detail/${widget.productID}";
