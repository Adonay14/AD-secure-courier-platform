...
class WithdrawalRequestCompletedDatatable extends ConsumerStatefulWidget {
  const WithdrawalRequestCompletedDatatable({super.key});

  @override
  ConsumerState<WithdrawalRequestCompletedDatatable> createState() =>
      _WithdrawalRequestCompletedDatatableState();
}

class _WithdrawalRequestCompletedDatatableState
    extends ConsumerState<WithdrawalRequestCompletedDatatable> {
  bool isLoaded = false;
