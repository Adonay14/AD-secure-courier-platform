...
class TopCustomers extends ConsumerStatefulWidget {
  const TopCustomers({super.key});

  @override
  ConsumerState<ConsumerStatefulWidget> createState() => _TopCustomersState();
}

class _TopCustomersState extends ConsumerState<TopCustomers> {
  @override
  Widget build(BuildContext context) {
    final prods = ref.watch(userOrdersCountProvider);
