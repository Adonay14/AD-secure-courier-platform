...
class AddSms extends ConsumerStatefulWidget {
  const AddSms({super.key});

  @override
  ConsumerState<AddSms> createState() => _AddSmsState();
}

class _AddSmsState extends ConsumerState<AddSms> {
  String uid = '';
  String title = '';
  String detail = '';
  String phone = '';
                      ...
                      children: [
                        ...
                        SizedBox(
                            ...
                            child: ElevatedButton(
                                ...
                                onPressed: emailDetail.enableSms == true
                                    ? null
                                    : () {
