...
class UsersData extends ConsumerStatefulWidget {
  const UsersData({super.key});

  @override
  ConsumerState<UsersData> createState() => _UsersDataState();
}

class _UsersDataState extends ConsumerState<UsersData> {
  bool isLoaded = false;
...
class VendorDataSource extends DataTableSource {
  ...
  VendorDataSource(this.vendor, this.themeListener);
