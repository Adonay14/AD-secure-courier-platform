      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            _SwitchListTileMenuItem(
                flag: 'assets/image/france.png',
                subtitle: 'French',
                title: 'FRANCE',
                locale: context.supportedLocales[4]),
            _SwitchListTileMenuItem(
                flag: 'assets/image/india.png',
                subtitle: 'Hindi',
                title: 'INDIA',
                locale: context.supportedLocales[5]),
            _SwitchListTileMenuItem(
                flag: 'assets/image/rusia.png',
                subtitle: 'Russian',
                title: 'RUSSIA',
                locale: context.supportedLocales[6]),
          ],
        ),
      ),
    );
      ...
      child: Card(
        ...
        child: ListTile(
            ...
            onTap: () async {
              ...
              await context.setLocale(widget.locale).then((value) async {
                if (context.mounted) {
