...
import 'package:user_web/widgets/flutterwave_web_widget.dart';
import 'package:user_web/widgets/paystack_web_widget.dart';
import 'package:user_web/widgets/transaction_history_widget.dart';
    ...
    return SingleChildScrollView(
      child: Column(
        children: [
          ...
          //     },
          //     leading: Image.network(
          //       'https://cdn.siasat.com/wp-content/uploads/2023/09/asvsavavad.jpg',
          //       height: 100,
          //       width: 50,
          //     ),
          //     title: const Text(
          ...
          //       style: TextStyle(fontWeight: FontWeight.bold),
          //     ),
          //     subtitle: const Text('Upload money with Razorpay payment gateway'),
          //     trailing: const Icon(Icons.chevron_right),
          //   ),
          const Gap(20),
          Padding(
